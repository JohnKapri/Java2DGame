...
public class Tile {
	...
	public static final Tile WATER = new AnimatedTile(4, "Water", new int [][] {{0, 5}, {1, 5}, {2, 5}, {1, 5}}, Colors.get(-1, 004, 115, -1), 0xFF0000FF, 400).setFriction(2).setCanStand(false);
	public static final Tile SWAMP = new AnimatedTile(5, "Swamp", new int [][] {{0, 5}, {1, 5}, {2, 5}, {1, 5}}, Colors.get(-1, 132, 143, -1), 0xFF008080, 800).setFriction(3).setCanStand(false);
