...
public class Tile {
	...
	public static final Tile GRASS_FLOWER_WHITE = new Tile(8, "Grass white flower", 5, 0, Colors.get(131, 541, 141, 554), 0xFF);
	public static final Tile GRASS_FLOWER_RED = new Tile(9, "Grass red flower", 5, 0, Colors.get(131, 555, 141, 510), 0xFF);
	...
	public static final Tile SPIKES = new Tile(3, "Spikes", 3, 0, Colors.get(-1, 333, 444, -1), 0xFFFF8800).setHarmfull(true).setMovementCost(8);
	public static final Tile WATER = new AnimatedTile(4, "Water", new int [][] {{0, 5}, {1, 5}, {2, 5}, {1, 5}}, Colors.get(-1, 004, 115, -1), 0xFF0000FF, 400).setFriction(2).setCanStand(false).setMovementCost(5);
	public static final Tile SWAMP = new AnimatedTile(5, "Swamp", new int [][] {{0, 5}, {1, 5}, {2, 5}, {1, 5}}, Colors.get(-1, 132, 143, -1), 0xFF008080, 800).setFriction(3).setCanStand(false).setMovementCost(5);
	...
	protected int baseMovementCost = 3;

	public Tile(int id, String name, int x, int y, int tileColor, int levelColor) {
		this.id = (byte) id;
		if (tiles[id] != null)
			throw new RuntimeException("Duplicant tile id at " + id
					+ "! Immediatly smash your display!");
		this.name = name;
	...
	protected Tile setCanStand(boolean b) {
		this.canStand = b;
		return this;
	}
	...
	protected Tile setMovementCost(int i) {
		this.baseMovementCost = i;
		return this;
	}
